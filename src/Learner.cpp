...
Learner::Learner(const MCMC &mca, const MCMC &mcb, const set<unsigned> &topVtxSet, string methodname) : m_MC_A(mca),
                                                                                                        m_MC_B(mcb),
                                                                                                        m_topVtxSet(
                                                                                                                topVtxSet),
                                                                                                        m_methodName(
...
unsigned MutualInfo::getTopVtx(unsigned *arrayTop, unsigned numTop) noexcept {
    unsigned i, j;
